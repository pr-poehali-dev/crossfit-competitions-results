...
const mockParticipants: Participant[] = [
  ...
  { id: 6, name: 'Белые и красивые', category: 'Новички МЖ', avatar: '❄️', members: ['Воробьев Кирилл', 'Рогожина Анна'], wod1_1: { result: '-', points: 0 }, wod1_2: { result: '-', points: 0 }, wod2: { result: '-', points: 0 }, wod3: { result: '-', points: 0 }, final: { place: 4, points: 0 }, totalScore: 0 },
  ...
  { id: 21, name: 'НЕЛИШНИЕ КИЛОГРАММЫ', category: 'Новички МЖ+', avatar: '⚖️', members: ['Жебуртович Татьяна', 'Жебуртович Сергей'], wod1_1: { result: '-', points: 0 }, wod1_2: { result: '-', points: 0 }, wod2: { result: '-', points: 0 }, wod3: { result: '-', points: 0 }, final: { place: 7, points: 0 }, totalScore: 0 },
  { id: 22, name: 'Любовь Васильевна меняет профессию', category: 'Новички МЖ+', avatar: '🆕', members: ['Запорожцев Сергей', 'Добровольская Любовь'], wod1_1: { result: '-', points: 0 }, wod1_2: { result: '-', points: 0 }, wod2: { result: '-', points: 0 }, wod3: { result: '-', points: 0 }, final: { place: 8, points: 0 }, totalScore: 0 },
