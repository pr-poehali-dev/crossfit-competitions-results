...
const mockParticipants: Participant[] = [
  // Команды Про
  { id: 1, name: 'Жертвы кроссфита', category: 'Команды Про', avatar: '🏆', members: ['Шилин Всеволод', 'Смирнов Иван', 'Кузьминцев Михаил', 'Феофанова Ярослава', 'Остапенко Динара', 'Иванова Татьяна'], wod1_1: { result: '-', points: 0 }, wod1_2: { result: '-', points: 0 }, wod2: { result: '-', points: 0 }, wod3_1: { result: '-', points: 0 }, wod3_2: { result: '-', points: 0 }, wod4_1: { result: '-', points: 0 }, wod4_2: { result: '-', points: 0 }, final: { place: 1, points: 0 }, totalScore: 0 },
  ...
  // Новички МЖ
  { id: 5, name: 'Ёлочный ЕМОМ', category: 'Новички МЖ', avatar: '🎄', members: ['Пивунов Никита', 'Боруцкая Анна'], wod1_1: { result: '137 кал', points: 90 }, wod1_2: { result: '272 повт', points: 95 }, wod2: { result: '-', points: 0 }, wod3: { result: '-', points: 0 }, final: { place: 1, points: 185 }, totalScore: 185 },
  { id: 6, name: 'Белые и красивые', category: 'Новички МЖ', avatar: '❄️', members: ['Воробьев Кирилл', 'Рогожина Анна'], wod1_1: { result: '144 кал', points: 95 }, wod1_2: { result: '263 повт', points: 85 }, wod2: { result: '-', points: 0 }, wod3: { result: '-', points: 0 }, final: { place: 2, points: 180 }, totalScore: 180 },
  { id: 13, name: 'Суперы', category: 'Новички МЖ', avatar: '🦸', members: ['Шмелев Павел', 'Стародумова Анна'], wod1_1: { result: '136 кал', points: 85 }, wod1_2: { result: '268 повт', points: 90 }, wod2: { result: '-', points: 0 }, wod3: { result: '-', points: 0 }, final: { place: 3, points: 175 }, totalScore: 175 },
  { id: 7, name: 'Любят адреналин, но возможно напиток', category: 'Новички МЖ', avatar: '🥤', members: ['Купреев Кирилл', 'Ляпунова Юлия'], wod1_1: { result: '118 кал', points: 60 }, wod1_2: { result: '305 повт', points: 100 }, wod2: { result: '-', points: 0 }, wod3: { result: '-', points: 0 }, final: { place: 4, points: 160 }, totalScore: 160 },
  { id: 4, name: 'Force of two', category: 'Новички МЖ', avatar: '⚡', members: ['Дьячков Иван', 'Стародубцева Инна'], wod1_1: { result: '150 кал', points: 100 }, wod1_2: { result: '216 повт', points: 55 }, wod2: { result: '-', points: 0 }, wod3: { result: '-', points: 0 }, final: { place: 5, points: 155 }, totalScore: 155 },
  { id: 8, name: 'Стар и млад', category: 'Новички МЖ', avatar: '👴', members: ['Смирнов Константин', 'Смирнова Анна'], wod1_1: { result: '127 кал', points: 70 }, wod1_2: { result: '243 повт', points: 80 }, wod2: { result: '-', points: 0 }, wod3: { result: '-', points: 0 }, final: { place: 6, points: 150 }, totalScore: 150 },
  { id: 11, name: 'Кошки-мышки', category: 'Новички МЖ', avatar: '🐱', members: ['Кучер Оксана', 'Кочетков Александр'], wod1_1: { result: '130 кал', points: 75 }, wod1_2: { result: '237 повт', points: 70 }, wod2: { result: '-', points: 0 }, wod3: { result: '-', points: 0 }, final: { place: 7, points: 145 }, totalScore: 145 },
  { id: 3, name: 'ПроМёд', category: 'Новички МЖ', avatar: '🍯', members: ['Воинов Тахир', 'Анненкова Кристина'], wod1_1: { result: '135 кал', points: 80 }, wod1_2: { result: '225 повт', points: 60 }, wod2: { result: '-', points: 0 }, wod3: { result: '-', points: 0 }, final: { place: 8, points: 140 }, totalScore: 140 },
  { id: 9, name: 'Белоснежка +1', category: 'Новички МЖ', avatar: '👸', members: ['Рюхина Олеся', 'Стебенев Андрей'], wod1_1: { result: '120 кал', points: 65 }, wod1_2: { result: '240 повт', points: 75 }, wod2: { result: '-', points: 0 }, wod3: { result: '-', points: 0 }, final: { place: 8, points: 140 }, totalScore: 140 },
  { id: 10, name: 'Маша и медведь', category: 'Новички МЖ', avatar: '🐻', members: ['Мурашова Алена', 'Мурашов Дмитрий'], wod1_1: { result: '117 кал', points: 55 }, wod1_2: { result: '228 повт', points: 65 }, wod2: { result: '-', points: 0 }, wod3: { result: '-', points: 0 }, final: { place: 10, points: 120 }, totalScore: 120 },
  { id: 12, name: 'Битой по зубам', category: 'Новички МЖ', avatar: '🏏', members: ['Евграфов Владимир', 'Евграфова Алла'], wod1_1: { result: '106 кал', points: 50 }, wod1_2: { result: '193 повт', points: 50 }, wod2: { result: '-', points: 0 }, wod3: { result: '-', points: 0 }, final: { place: 11, points: 100 }, totalScore: 100 },
  ...
  // Новички МЖ+
  { id: 15, name: 'Семейные', category: 'Новички МЖ+', avatar: '👨‍👩‍👧', members: ['Виноградова Юлия', 'Кашин Артем'], wod1_1: { result: '134 кал', points: 60 }, wod1_2: { result: '207 повт', points: 30 }, wod2: { result: '-', points: 0 }, wod3: { result: '-', points: 0 }, final: { place: 10, points: 90 }, totalScore: 90 },
  { id: 16, name: 'Лило и Стич', category: 'Новички МЖ+', avatar: '🌺', members: ['Сорокина Мария', 'Беляев Владислав'], wod1_1: { result: '138 кал', points: 80 }, wod1_2: { result: '234 повт', points: 75 }, wod2: { result: '-', points: 0 }, wod3: { result: '-', points: 0 }, final: { place: 5, points: 155 }, totalScore: 155 },
  { id: 17, name: 'Steel&fire', category: 'Новички МЖ+', avatar: '🔥', members: ['Сикачев Денис', 'Тер-Микаелян Мария'], wod1_1: { result: '147 кал', points: 95 }, wod1_2: { result: '254 повт', points: 80 }, wod2: { result: '-', points: 0 }, wod3: { result: '-', points: 0 }, final: { place: 3, points: 175 }, totalScore: 175 },
  { id: 18, name: 'Одуванчики', category: 'Новички МЖ+', avatar: '🌼', members: ['Ларин Иван', 'Подтуркина Екатерина'], wod1_1: { result: '146 кал', points: 90 }, wod1_2: { result: '264 повт', points: 85 }, wod2: { result: '-', points: 0 }, wod3: { result: '-', points: 0 }, final: { place: 3, points: 175 }, totalScore: 175 },
  { id: 19, name: 'Елки ИГО голки', category: 'Новички МЖ+', avatar: '🎄', members: ['Клугман Любовь', 'Букарев Сергей'], wod1_1: { result: '114 кал', points: 15 }, wod1_2: { result: '224 повт', points: 45 }, wod2: { result: '-', points: 0 }, wod3: { result: '-', points: 0 }, final: { place: 17, points: 60 }, totalScore: 60 },
  { id: 20, name: 'Елочные гладиаторы', category: 'Новички МЖ+', avatar: '⚔️', members: ['Озеров Павел', 'Травина Алина'], wod1_1: { result: '151 кал', points: 100 }, wod1_2: { result: '265 повт', points: 90 }, wod2: { result: '-', points: 0 }, wod3: { result: '-', points: 0 }, final: { place: 1, points: 190 }, totalScore: 190 },
  { id: 21, name: 'НЕЛИШНИЕ КИЛОГРАММЫ', category: 'Новички МЖ+', avatar: '⚖️', members: ['Жебуртович Татьяна', 'Жебуртович Сергей'], wod1_1: { result: '138 кал', points: 80 }, wod1_2: { result: '336 повт', points: 100 }, wod2: { result: '-', points: 0 }, wod3: { result: '-', points: 0 }, final: { place: 2, points: 180 }, totalScore: 180 },
  { id: 22, name: 'Любовь Васильевна меняет профессию', category: 'Новички МЖ+', avatar: '🆕', members: ['Запорожцев Сергей', 'Добровольская Любовь'], wod1_1: { result: '126 кал', points: 40 }, wod1_2: { result: '207 повт', points: 30 }, wod2: { result: '-', points: 0 }, wod3: { result: '-', points: 0 }, final: { place: 15, points: 70 }, totalScore: 70 },
  { id: 23, name: 'НикОля', category: 'Новички МЖ+', avatar: '🎅', members: ['Заботин Никита', 'Сенчук Ольга'], wod1_1: { result: '141 кал', points: 85 }, wod1_2: { result: '227 повт', points: 55 }, wod2: { result: '-', points: 0 }, wod3: { result: '-', points: 0 }, final: { place: 7, points: 140 }, totalScore: 140 },
  { id: 24, name: 'Hoops&Wilde', category: 'Новички МЖ+', avatar: '🏀', members: ['Ляда Тарас', 'Прудникова Екатерина'], wod1_1: { result: '131 кал', points: 50 }, wod1_2: { result: '266 повт', points: 95 }, wod2: { result: '-', points: 0 }, wod3: { result: '-', points: 0 }, final: { place: 6, points: 145 }, totalScore: 145 },
  { id: 25, name: 'Можем хуже', category: 'Новички МЖ+', avatar: '🤷', members: ['Пресняков Илья', 'Кудрявцева Надежда'], wod1_1: { result: '137 кал', points: 70 }, wod1_2: { result: '205 повт', points: 15 }, wod2: { result: '-', points: 0 }, wod3: { result: '-', points: 0 }, final: { place: 12, points: 85 }, totalScore: 85 },
  { id: 26, name: 'Однофамильцы', category: 'Новички МЖ+', avatar: '👥', members: ['Тарасенко Андрей', 'Тарасенко Ольга'], wod1_1: { result: '123 кал', points: 30 }, wod1_2: { result: '210 повт', points: 35 }, wod2: { result: '-', points: 0 }, wod3: { result: '-', points: 0 }, final: { place: 16, points: 65 }, totalScore: 65 },
  { id: 27, name: 'Зов Джунглей', category: 'Новички МЖ+', avatar: '🎯', members: ['Ватутина Маргарита', 'Ватутин Роман'], wod1_1: { result: '124 кал', points: 35 }, wod1_2: { result: '225 повт', points: 50 }, wod2: { result: '-', points: 0 }, wod3: { result: '-', points: 0 }, final: { place: 12, points: 85 }, totalScore: 85 },
  { id: 28, name: 'Внуки Деда Мороза', category: 'Новички МЖ+', avatar: '🎅', members: ['Бекмурадова Илона', 'Павлов Константин'], wod1_1: { result: '128 кал', points: 45 }, wod1_2: { result: '180 повт', points: 10 }, wod2: { result: '-', points: 0 }, wod3: { result: '-', points: 0 }, final: { place: 18, points: 55 }, totalScore: 55 },
  { id: 29, name: 'Мутный Енот', category: 'Новички МЖ+', avatar: '🦝', members: ['Игнатьев Дмитрий', 'Кольцова Яна'], wod1_1: { result: '135 кал', points: 65 }, wod1_2: { result: '211 повт', points: 40 }, wod2: { result: '-', points: 0 }, wod3: { result: '-', points: 0 }, final: { place: 9, points: 105 }, totalScore: 105 },
  { id: 30, name: 'Ух ты пухты', category: 'Новички МЖ+', avatar: '🎉', members: ['Немешаева Оксана', 'Немешаев Максим'], wod1_1: { result: '132 кал', points: 55 }, wod1_2: { result: '228 повт', points: 65 }, wod2: { result: '-', points: 0 }, wod3: { result: '-', points: 0 }, final: { place: 8, points: 120 }, totalScore: 120 },
  { id: 31, name: 'Нас заставили', category: 'Новички МЖ+', avatar: '🌟', members: ['Устимов Егор', 'Комиссарова Юлия'], wod1_1: { result: '114 кал', points: 15 }, wod1_2: { result: '230 повт', points: 70 }, wod2: { result: '-', points: 0 }, wod3: { result: '-', points: 0 }, final: { place: 12, points: 85 }, totalScore: 85 },
  { id: 32, name: 'Пухлые утки', category: 'Новички МЖ+', avatar: '🦆', members: ['Горфинкель Анна', 'Устюгов Никита'], wod1_1: { result: '118 кал', points: 25 }, wod1_2: { result: '228 повт', points: 65 }, wod2: { result: '-', points: 0 }, wod3: { result: '-', points: 0 }, final: { place: 10, points: 90 }, totalScore: 90 },
  { id: 33, name: 'Киля', category: 'Новички МЖ+', avatar: '⚓', members: ['Малинкин Кирилл', 'Петухова Ольга'], wod1_1: { result: '115 кал', points: 20 }, wod1_2: { result: '207 повт', points: 30 }, wod2: { result: '-', points: 0 }, wod3: { result: '-', points: 0 }, final: { place: 19, points: 50 }, totalScore: 50 },
];
