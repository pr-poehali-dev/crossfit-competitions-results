...
const mockParticipants: Participant[] = [
  ...
  { id: 521, name: 'НЕЛИШНИЕ КИЛОГРАММЫ', category: 'Новички МЖ+', avatar: '⚖️', members: ['Жебуртович Татьяна', 'Жебрутович Сергей'], wod1_1: { result: '138 кал', points: 80 }, wod1_2: { result: '336 повт', points: 100 }, wod2: { result: '318 повт', points: 80 }, wod3_1: { result: '6:40 (328 повт)', points: 80 }, wod3_2: { result: '', points: 0 }, final: { place: 4, points: 340 }, totalScore: 340 },
  ...
  { id: 526, name: 'Ух ты пухты', category: 'Новички МЖ+', avatar: '🎯', members: ['Немешаева Оксана', 'Немешаев Максим'], wod1_1: { result: '132 кал', points: 55 }, wod1_2: { result: '228 повт', points: 65 }, wod2: { result: '298 повт', points: 55 }, wod3_1: { result: '6:56 (328 повт)', points: 70 }, wod3_2: { result: '', points: 0 }, final: { place: 8, points: 245 }, totalScore: 245 },
  { id: 529, name: 'Мутный Енот', category: 'Новички МЖ+', avatar: '🦝', members: ['Игнатьев Дмитрий', 'Кольцова Яна'], wod1_1: { result: '135 кал', points: 65 }, wod1_2: { result: '211 повт', points: 40 }, wod2: { result: '311 повт', points: 75 }, wod3_1: { result: '7:10 (328 повт)', points: 60 }, wod3_2: { result: '', points: 0 }, final: { place: 9, points: 240 }, totalScore: 240 },
  { id: 532, name: 'Пухлые утки', category: 'Новички МЖ+', avatar: '🦆', members: ['Горфинкель Анна', 'Устюгов Никита'], wod1_1: { result: '118 кал', points: 25 }, wod1_2: { result: '228 повт', points: 65 }, wod2: { result: '305 повт', points: 65 }, wod3_1: { result: '7:08 (328 повт)', points: 65 }, wod3_2: { result: '', points: 0 }, final: { place: 10, points: 220 }, totalScore: 220 },
  { id: 527, name: 'Зов Джунглей', category: 'Новички МЖ+', avatar: '🐆', members: ['Ватутина Маргарита', 'Ватутин Роман'], wod1_1: { result: '124 кал', points: 35 }, wod1_2: { result: '225 повт', points: 50 }, wod2: { result: '287 повт', points: 35 }, wod3_1: { result: '7:12 (328 повт)', points: 55 }, wod3_2: { result: '', points: 0 }, final: { place: 11, points: 175 }, totalScore: 175 },
  { id: 522, name: 'Все еще новички', category: 'Новички МЖ+', avatar: '🆕', members: ['Запорожцев Сергей', 'Добровольская Любовь'], wod1_1: { result: '126 кал', points: 40 }, wod1_2: { result: '207 повт', points: 30 }, wod2: { result: '300 повт', points: 60 }, wod3_1: { result: '7:24 (328 повт)', points: 40 }, wod3_2: { result: '', points: 0 }, final: { place: 12, points: 170 }, totalScore: 170 },
  ...
  { id: 531, name: 'Нас заставили', category: 'Новички МЖ+', avatar: '😤', members: ['Устимов Егор', 'Комиссарова Юлия'], wod1_1: { result: '114 кал', points: 15 }, wod1_2: { result: '230 повт', points: 70 }, wod2: { result: '272 повт', points: 20 }, wod3_1: { result: '7:20 (328 повт)', points: 45 }, wod3_2: { result: '', points: 0 }, final: { place: 14, points: 150 }, totalScore: 150 },
  { id: 525, name: 'Можем хуже', category: 'Новички МЖ+', avatar: '🤷', members: ['Пресняков Илья', 'Кудрявцева Надежда'], wod1_1: { result: '137 кал', points: 70 }, wod1_2: { result: '205 повт', points: 15 }, wod2: { result: '282 повт', points: 30 }, wod3_1: { result: '8:13 (328 повт)', points: 20 }, wod3_2: { result: '', points: 0 }, final: { place: 16, points: 135 }, totalScore: 135 },
  { id: 530, name: 'Однофамильцы', category: 'Новички МЖ+', avatar: '👥', members: ['Тарасенко Андрей', 'Тарасенко Ольга'], wod1_1: { result: '123 кал', points: 30 }, wod1_2: { result: '210 повт', points: 35 }, wod2: { result: '295 повт', points: 45 }, wod3_1: { result: '7:44 (328 повт)', points: 30 }, wod3_2: { result: '', points: 0 }, final: { place: 15, points: 140 }, totalScore: 140 },
  ...
  { id: 528, name: 'Внуки Деда Мороза', category: 'Новички МЖ+', avatar: '🎅', members: ['Бекмурадова Илона', 'Павлов Константин'], wod1_1: { result: '128 кал', points: 45 }, wod1_2: { result: '180 повт', points: 10 }, wod2: { result: '281 повт', points: 25 }, wod3_1: { result: '8:08 (328 повт)', points: 25 }, wod3_2: { result: '', points: 0 }, final: { place: 18, points: 105 }, totalScore: 105 },
  { id: 533, name: 'Киля', category: 'Новички МЖ+', avatar: '⚓', members: ['Малинкин Кирилл', 'Петухова Ольга'], wod1_1: { result: '115 кал', points: 20 }, wod1_2: { result: '207 повт', points: 30 }, wod2: { result: '271 повт', points: 15 }, wod3_1: { result: '9:05 (228 повт)', points: 10 }, wod3_2: { result: '', points: 0 }, final: { place: 19, points: 75 }, totalScore: 75 },
];
