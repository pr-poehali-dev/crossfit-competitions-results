  ...
  { 
    ...
    heats: [
      ...
      { 
        ...
        category: 'Заход 2',
        teams: [
          'Любят адреналин, но возможно напиток (Новички МЖ, дорожка 1)',
          'Белоснежка +1 (Новички МЖ, дорожка 2)',
          'Маша и медведь (Новички МЖ, дорожка 3)',
          'Семейные (Новички МЖ+, дорожка 4)',
          'Лило и Стич (Новички МЖ+, дорожка 5)',
          'Steel&fire (Новички МЖ+, дорожка 6)'
        ]
      },
      { 
        time: '10:18', 
        category: 'Заход 3',
        teams: [
          'ПроМёд (Новички МЖ, дорожка 1)',
          'Force of two (Новички МЖ, дорожка 2)',
          'ХМЕЛИСУМЕЛИ (Новички МЖ, дорожка 3)',
          'Одуванчики (Новички МЖ+, дорожка 4)',
          'Елки ИГО голки (Новички МЖ+, дорожка 5)',
          'Елочные гладиаторы (Новички МЖ+, дорожка 6)'
        ]
      },
      { 
        time: '10:30', 
        category: 'Заход 4',
        teams: [
          'Кошки-мышки (Новички МЖ, дорожка 1)',
          'Битой по зубам (Новички МЖ, дорожка 2)',
          'НЕЛИШНИЕ КИЛОГРАММЫ (Новички МЖ+, дорожка 3)',
          'Все еще новички (Новички МЖ+, дорожка 4)',
          'НикОля (Новички МЖ+, дорожка 5)',
          'Hoops&Wilde (Новички МЖ+, дорожка 6)'
        ]
      },
      { 
        time: '10:43', 
        category: 'Заход 5',
        teams: [
          'Ёлочный ЕМОМ (Новички МЖ, дорожка 1)',
                    ...
                    <div className="bg-white/5 rounded-lg border border-white/20 overflow-hidden">
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <div className="text-left">
                            <h4 className="text-xl font-bold text-primary">Комплекс 1</h4>
                            <p className="text-sm text-white/60">ПРОДВИНУТЫЕ</p>
                          </div>
                        </div>
                        <Icon 
                    ...
                    <div className="bg-white/5 rounded-lg border border-white/20 overflow-hidden">
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <div className="text-left">
                            <h4 className="text-xl font-bold text-primary">Комплекс 2</h4>
                            <p className="text-sm text-white/60">В двойках</p>
                          </div>
                        </div>
                        <Icon 
                    ...
                    <div className="bg-white/5 rounded-lg border border-white/20 overflow-hidden">
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <div className="text-left">
                            <h4 className="text-xl font-bold text-primary">Комплекс 3</h4>
                            <p className="text-sm text-white/60">Крышка 15 минут</p>
                          </div>
                        </div>
                        <Icon 
