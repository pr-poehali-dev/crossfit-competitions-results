...
const mockParticipants: Participant[] = [
  ...
  { id: 2, name: 'Тирамисучки', category: 'Новички МЖ', avatar: '🍰', wod1_1: { result: '10:01:00', points: 55 }, wod1_2: { result: '5:39:00', points: 100 }, wod2_1: { result: '-', points: 0 }, wod2_2: { result: '-', points: 0 }, wod3: { result: '-', points: 0 }, final: { place: 2, points: 0 }, totalScore: 155 },
  { id: 3, name: 'BARсучки', category: 'Новички МЖ', avatar: '🍻', wod1_1: { result: '8:54:00', points: 95 }, wod1_2: { result: '7:24:00', points: 75 }, wod2_1: { result: '-', points: 0 }, wod2_2: { result: '-', points: 0 }, wod3: { result: '-', points: 0 }, final: { place: 3, points: 0 }, totalScore: 170 },
  ...
  { id: 5, name: 'Любим печеньки', category: 'Новички МЖ', avatar: '🍪', wod1_1: { result: '9:22:00', points: 85 }, wod1_2: { result: '7:01:00', points: 85 }, wod2_1: { result: '-', points: 0 }, wod2_2: { result: '-', points: 0 }, wod3: { result: '-', points: 0 }, final: { place: 5, points: 0 }, totalScore: 170 },
  ...
  { id: 7, name: 'The best', category: 'Новички МЖ', avatar: '🏆', wod1_1: { result: '9:38:00', points: 80 }, wod1_2: { result: '8:44:00', points: 50 }, wod2_1: { result: '-', points: 0 }, wod2_2: { result: '-', points: 0 }, wod3: { result: '-', points: 0 }, final: { place: 7, points: 0 }, totalScore: 130 },
  { id: 8, name: 'ХВАТТЯГИ', category: 'Новички МЖ', avatar: '💥', wod1_1: { result: '9:41:00', points: 70 }, wod1_2: { result: '8:03:00', points: 60 }, wod2_1: { result: '-', points: 0 }, wod2_2: { result: '-', points: 0 }, wod3: { result: '-', points: 0 }, final: { place: 8, points: 0 }, totalScore: 130 },
  { id: 9, name: 'Двое из ларца', category: 'Новички МЖ', avatar: '🎭', wod1_1: { result: '9:38:00', points: 80 }, wod1_2: { result: '8:02:00', points: 65 }, wod2_1: { result: '-', points: 0 }, wod2_2: { result: '-', points: 0 }, wod3: { result: '-', points: 0 }, final: { place: 9, points: 0 }, totalScore: 145 },
  { id: 10, name: 'БандаДам', category: 'Новички МЖ', avatar: '👑', wod1_1: { result: '9:42:00', points: 65 }, wod1_2: { result: '7:21:00', points: 80 }, wod2_1: { result: '-', points: 0 }, wod2_2: { result: '-', points: 0 }, wod3: { result: '-', points: 0 }, final: { place: 10, points: 0 }, totalScore: 145 },
  ...
  { id: 12, name: 'Вишенки', category: 'Новички МЖ', avatar: '🍒', wod1_1: { result: '10:13:00', points: 45 }, wod1_2: { result: '9:12:00', points: 40 }, wod2_1: { result: '-', points: 0 }, wod2_2: { result: '-', points: 0 }, wod3: { result: '-', points: 0 }, final: { place: 12, points: 0 }, totalScore: 85 },
  { id: 13, name: 'Одуванчики', category: 'Новички МЖ', avatar: '🌼', wod1_1: { result: '10:03:00', points: 50 }, wod1_2: { result: '9:03:00', points: 45 }, wod2_1: { result: '-', points: 0 }, wod2_2: { result: '-', points: 0 }, wod3: { result: '-', points: 0 }, final: { place: 13, points: 0 }, totalScore: 95 },
];
